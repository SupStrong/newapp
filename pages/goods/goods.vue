...
.main_nav {
	...
	padding: 40rpx 64rpx 36rpx 58rpx;
	background: #ffffff;
	box-shadow: 0 4rpx 40rpx 0 rgba(13, 104, 230, 0.05);
	border-radius: 16rpx;
	margin: 32rpx;
	&::after {
		content: '';
